...
exhibition_router = APIRouter()

@exhibition_router.post("/api/exhibitions")
...
@exhibition_router.delete("/api/exhibitions/{slug}")
...
@exhibition_router.get("/api/exhibitions/{slug}")
...
@exhibition_router.get("/api/categories/{category_slug}/exhibitions")
...
@exhibition_router.get("/api/exhibitions")
